...
//aaaa
    ...
    public static void main(String[] args) {
        ...
        o.add("e|---12-------12----12-11-9-----4-----4---4-5-7-------|\n" +
                "B|------12-------12---------------0-----0-------------|\n" +
                "G|---------13-------13-11-9---------4-----------------|\n" +
                "D|------------------------------------------7-9-------|\n" +
                "A|----------------------------------------------------|\n" +
                "E|-0--------------------------4-----------4-----------|");
        o.add("e|---2-----2-----2-----2-----5-----5-7--7-------------|\n" +
                "B|-----0-----0-----0-----0-----0----------------------|\n" +
                "G|-------2-----------2-----------6------8-------------|\n" +
                "D|----------------------------------------------------|\n" +
                "A|-------------------------0--------------------------|\n" +
                "E|-2-----------2------------------------7-------------|");
        o.add("e|---12-------12----12-11-9-----4-----4-----4-----4---|\n" +
                "B|------12-------12---------------0-----0-----0-----0-|\n" +
                "G|---------13-------13-11-9---------4-----------4-----|\n" +
                "D|----------------------------------------------------|\n" +
                "A|----------------------------------------------------|\n" +
       ...
       ArrayList<String> a = GuitarConvert.tempConvert("Intro\n" +
                "e|---12-------12----12-11-9-----4-----4---4-5-7-------|\n" +
                "B|------12-------12---------------0-----0-------------|\n" +
                "G|---------13-------13-11-9---------4-----------------|\n" +
                "D|------------------------------------------7-9-------|\n" +
                "A|----------------------------------------------------|\n" +
